  ...
  if (UWorld* World = GEngine->GetWorldFromContextObject(WorldContextObject))
    {
      ...
      LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID, ContinueAction = new FContinueAction<UVaRestJsonObject*>(this, Result, LatentInfo, LatentInfo.CallFrame));
    }
